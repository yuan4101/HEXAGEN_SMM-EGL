...
import smm.ParamKind;
import smm.Parameter;
import smm.PrimitiveType;
import smm.QueryMethod;
import smm.ReferenceType;
import smm.RelationType;
...
public class SmmPackageImpl extends EPackageImpl implements SmmPackage {
	 ...
	 * @generated
	 */
	private EEnum paramKindEEnum = null;
	...
	public static SmmPackage init() {
		...
		Object registeredSmmPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		SmmPackageImpl theSmmPackage = registeredSmmPackage instanceof SmmPackageImpl ? (SmmPackageImpl)registeredSmmPackage : new SmmPackageImpl();
	 ...
	 */
	@Override
	public EAttribute getRelationship_MappedBy() {
	 ...
	 */
	@Override
	public EAttribute getRelationship_FieldName() {
	 ...
	 */
	@Override
	public EAttribute getApplication_JavaVersion() {
	 ...
	 */
	@Override
	public EAttribute getApplication_ServerPort() {
	 ...
	 */
	@Override
	public EReference getApplication_ValueObjects() {
	 ...
	 */
	@Override
	public EReference getJavaClass_Attributes() {
	 ...
	 */
	@Override
	public EAttribute getEntity_IdGenerationStrategy() {
	 ...
	 */
	@Override
	public EAttribute getQueryMethod_Query() {
	 ...
	 */
	@Override
	public EAttribute getUseCase_Transactional() {
	 ...
	 */
	@Override
	public EReference getService_UseCases() {
	 ...
	 */
	@Override
	public EReference getService_Repositories() {
	 ...
	 */
	@Override
	public EAttribute getEndpoint_HttpMethod() {
	 ...
	 */
	@Override
	public EAttribute getEndpoint_Path() {
	 ...
	 */
	@Override
	public EAttribute getEndpoint_ResponseCode() {
	 ...
	 */
	@Override
	public EReference getEndpoint_RequestDTO() {
	 ...
	 */
	@Override
	public EReference getEndpoint_ResponseDTO() {
	 ...
	 */
	@Override
	public EAttribute getController_BasePath() {
	 ...
	 */
	@Override
	public EReference getController_Service() {
	 ...
	 */
	@Override
	public EEnum getParamKind() {
		return paramKindEEnum;
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(relationshipEClass, RELATIONSHIP__MAPPED_BY);
		createEAttribute(relationshipEClass, RELATIONSHIP__FIELD_NAME);
		...
		createEAttribute(applicationEClass, APPLICATION__JAVA_VERSION);
		createEAttribute(applicationEClass, APPLICATION__SERVER_PORT);
		createEReference(applicationEClass, APPLICATION__ENTITIES);
		createEReference(applicationEClass, APPLICATION__VALUE_OBJECTS);
		...
		createEReference(javaClassEClass, JAVA_CLASS__ATTRIBUTES);
		createEReference(javaClassEClass, JAVA_CLASS__METHODS);

		entityEClass = createEClass(ENTITY);
		createEAttribute(entityEClass, ENTITY__TABLE_NAME);
		createEAttribute(entityEClass, ENTITY__ID_GENERATION_STRATEGY);
		...
		createEAttribute(queryMethodEClass, QUERY_METHOD__QUERY);
		...
		createEAttribute(useCaseEClass, USE_CASE__TRANSACTIONAL);

		serviceEClass = createEClass(SERVICE);
		createEReference(serviceEClass, SERVICE__USE_CASES);
		createEReference(serviceEClass, SERVICE__REPOSITORIES);

		endpointEClass = createEClass(ENDPOINT);
		createEAttribute(endpointEClass, ENDPOINT__HTTP_METHOD);
		createEAttribute(endpointEClass, ENDPOINT__PATH);
		createEAttribute(endpointEClass, ENDPOINT__RESPONSE_CODE);
		createEReference(endpointEClass, ENDPOINT__REQUEST_DTO);
		createEReference(endpointEClass, ENDPOINT__RESPONSE_DTO);
		...
		createEAttribute(controllerEClass, CONTROLLER__BASE_PATH);
		createEReference(controllerEClass, CONTROLLER__SERVICE);
		...
		paramKindEEnum = createEEnum(PARAM_KIND);
	...
	public void initializePackageContents() {
		...
		javaClassEClass.getESuperTypes().add(this.getNamedElement());
		entityEClass.getESuperTypes().add(this.getJavaClass());
		valueObjectEClass.getESuperTypes().add(this.getJavaClass());
		queryMethodEClass.getESuperTypes().add(this.getMethod());
		repositoryEClass.getESuperTypes().add(this.getNamedElement());
		useCaseEClass.getESuperTypes().add(this.getMethod());
		serviceEClass.getESuperTypes().add(this.getJavaClass());
		endpointEClass.getESuperTypes().add(this.getMethod());
		...
		initEAttribute(getRelationship_Type(), this.getRelationType(), "type", null, 0, 1, Relationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRelationship_MappedBy(), ecorePackage.getEString(), "mappedBy", null, 0, 1, Relationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRelationship_FieldName(), ecorePackage.getEString(), "fieldName", null, 0, 1, Relationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getReferenceType_Entity(), this.getEntity(), null, "entity", null, 0, 1, ReferenceType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getApplication_JavaVersion(), ecorePackage.getEString(), "javaVersion", null, 0, 1, Application.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getApplication_ServerPort(), ecorePackage.getEString(), "serverPort", null, 0, 1, Application.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getApplication_ValueObjects(), this.getValueObject(), null, "valueObjects", null, 0, -1, Application.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getApplication_Controllers(), this.getController(), null, "controllers", null, 0, -1, Application.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getJavaClass_Attributes(), this.getAttribute(), null, "attributes", null, 0, -1, JavaClass.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getEntity_IdGenerationStrategy(), this.getGenerationType(), "idGenerationStrategy", null, 0, 1, Entity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getQueryMethod_Query(), ecorePackage.getEString(), "query", null, 0, 1, QueryMethod.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRepository_Queries(), this.getQueryMethod(), null, "queries", null, 0, -1, Repository.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(useCaseEClass, UseCase.class, "UseCase", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getUseCase_Transactional(), ecorePackage.getEBoolean(), "transactional", null, 0, 1, UseCase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(serviceEClass, Service.class, "Service", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getService_UseCases(), this.getUseCase(), null, "useCases", null, 0, -1, Service.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getService_Repositories(), this.getRepository(), null, "repositories", null, 0, -1, Service.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(endpointEClass, Endpoint.class, "Endpoint", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getEndpoint_HttpMethod(), this.getHttpMethod(), "httpMethod", null, 0, 1, Endpoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEndpoint_Path(), ecorePackage.getEString(), "path", null, 0, 1, Endpoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEndpoint_ResponseCode(), ecorePackage.getEInt(), "responseCode", null, 0, 1, Endpoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEndpoint_RequestDTO(), this.getDTO(), null, "requestDTO", null, 0, 1, Endpoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEndpoint_ResponseDTO(), this.getDTO(), null, "responseDTO", null, 0, 1, Endpoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getParameter_Kind(), this.getParamKind(), "kind", null, 0, 1, Parameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(dtoEClass, smm.DTO.class, "DTO", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(controllerEClass, Controller.class, "Controller", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getController_BasePath(), ecorePackage.getEString(), "basePath", null, 0, 1, Controller.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getController_Service(), this.getService(), null, "service", null, 0, 1, Controller.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEEnum(paramKindEEnum, ParamKind.class, "ParamKind");
		addEEnumLiteral(paramKindEEnum, ParamKind.PATH);
		addEEnumLiteral(paramKindEEnum, ParamKind.QUERY);
		addEEnumLiteral(paramKindEEnum, ParamKind.BODY);
