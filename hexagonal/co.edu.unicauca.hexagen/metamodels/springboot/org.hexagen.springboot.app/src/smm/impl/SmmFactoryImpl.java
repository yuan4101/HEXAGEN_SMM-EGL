...
public class SmmFactoryImpl extends EFactoryImpl implements SmmFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case SmmPackage.RELATIONSHIP: return createRelationship();
			case SmmPackage.PRIMITIVE_TYPE: return createPrimitiveType();
			case SmmPackage.REFERENCE_TYPE: return createReferenceType();
			case SmmPackage.ATTRIBUTE: return createAttribute();
			case SmmPackage.APPLICATION: return createApplication();
			case SmmPackage.ENTITY: return createEntity();
			case SmmPackage.VALUE_OBJECT: return createValueObject();
			case SmmPackage.QUERY_METHOD: return createQueryMethod();
			case SmmPackage.REPOSITORY: return createRepository();
			case SmmPackage.USE_CASE: return createUseCase();
			case SmmPackage.SERVICE: return createService();
			case SmmPackage.ENDPOINT: return createEndpoint();
			case SmmPackage.PARAMETER: return createParameter();
			case SmmPackage.DTO: return createDTO();
			case SmmPackage.CONTROLLER: return createController();
			case SmmPackage.METHOD: return createMethod();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case SmmPackage.HTTP_METHOD:
				return createHttpMethodFromString(eDataType, initialValue);
			case SmmPackage.PARAM_KIND:
				return createParamKindFromString(eDataType, initialValue);
			case SmmPackage.GENERATION_TYPE:
				return createGenerationTypeFromString(eDataType, initialValue);
			case SmmPackage.RELATION_TYPE:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			...
			case SmmPackage.PARAM_KIND:
				return convertParamKindToString(eDataType, instanceValue);
			case SmmPackage.GENERATION_TYPE:
	 ...
	 * @generated
	 */
	public ParamKind createParamKindFromString(EDataType eDataType, String initialValue) {
		ParamKind result = ParamKind.get(initialValue);
		if (result == null) throw new IllegalArgumentException("The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
		return result;
	}
	 ...
	 * @generated
	 */
	public String convertParamKindToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
